...
export const israelAreas: Area[] = [
  ...
  { name: 'כל אזור ירושלים', area: 'אזור ירושלים', id: 58 },
  ...
  { name: 'כל אזור יהודה ושומרון', area: 'יהודה ושומרון', id: 59 },
  ...
  { name: 'כל השפלה', area: 'השפלה', id: 60 },
  ...
  { name: 'כל חדרה זכרון והעמקים', area: 'חדרה זכרון והעמקים', id: 63 },
  ...
  { name: 'כל השרון', area: 'השרון', id: 64 },
